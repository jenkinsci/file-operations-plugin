...
public class FileUnTarOperationTest {
    @Rule
    ...
    @Test
    public void testUnTarRegularTarFile() throws Exception {
        ...
        try (TarArchiveOutputStream out = new TarArchiveOutputStream(
                new BufferedOutputStream(new FileOutputStream(new File(tarFile.getRemote()))))) {
    ...
    @Test
    public void testUnTarGzipFile() throws Exception {
        ...
        try (TarArchiveOutputStream out = new TarArchiveOutputStream(
                new GzipCompressorOutputStream(
                    new BufferedOutputStream(new FileOutputStream(new File(tarGzFile.getRemote())))))) {
            out.setLongFileMode(TarArchiveOutputStream.LONGFILE_GNU);
    ...
    @Test
    public void testUnTarNonExistentFile() throws Exception {
